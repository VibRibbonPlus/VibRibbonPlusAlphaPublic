// <copyright file="ChatController.cs" company="RedHead">
...
public class ChatController : MonoBehaviour
{
    ...
    private void OnEnable() => TMP_ChatInput.onSubmit.AddListener(AddToChatOutput);

    private void OnDisable() => TMP_ChatInput.onSubmit.RemoveListener(AddToChatOutput);
