// <copyright file="StandaloneFileBrowserWindows.cs" company="RedHead">
...
namespace SFB
{
    ...
    public class StandaloneFileBrowserWindows : IStandaloneFileBrowser
    {
        ...
        public void OpenFilePanelAsync(string title, string directory, ExtensionFilter[] extensions, bool multiselect, Action<string[]> cb) => cb.Invoke(OpenFilePanel(title, directory, extensions, multiselect));
        ...
        public void OpenFolderPanelAsync(string title, string directory, bool multiselect, Action<string[]> cb) => cb.Invoke(OpenFolderPanel(title, directory, multiselect));
        ...
        public void SaveFilePanelAsync(string title, string directory, string defaultName, ExtensionFilter[] extensions, Action<string> cb) => cb.Invoke(SaveFilePanel(title, directory, defaultName, extensions));
